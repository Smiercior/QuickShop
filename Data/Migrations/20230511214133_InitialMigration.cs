        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParametersLink = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_AspNetUsers_PersonId",
                        column: x => x.PersonId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliveryTypePrices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeliveryTypePrices_DeliveryTypes_DeliveryTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductRatings_AspNetUsers_PersonId",
                        column: x => x.PersonId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryTypeId = table.Column<int>(type: "int", nullable: false),
                    DeliveryTypePriceId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductTransactions_AspNetUsers_PersonId",
                        column: x => x.PersonId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        column: x => x.DeliveryTypePriceId,
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductTransactions_ProductPrices_ProductPriceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Chats_AspNetUsers_PersonId",
                        column: x => x.PersonId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Chats_ProductTransactions_ProductTransactionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatEntries_AspNetUsers_PersonId",
                        column: x => x.PersonId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatEntries_PersonId",
                table: "ChatEntries",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_Chats_PersonId",
                table: "Chats",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_Chats_ProductTransactionId",
                table: "Chats",
                column: "ProductTransactionId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryTypePrices_DeliveryTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductRatings_PersonId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTransactions_PersonId",
                table: "ProductTransactions",
                column: "PersonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTransactions_ProductPriceId",
                table: "ProductTransactions",
